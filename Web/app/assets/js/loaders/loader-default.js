...
var _requireJs = {
    config: {
        ...
        shim: {
            ...
            'Lang': {
                deps: ["text!languages.json", "text!defaultLanguage.json", "markdown", "Message"]
            },
            'MessageLang': {
                deps: []
            },
...
], function (_validatorExtended, _languages, _defaultLanguage, _lang, _messageLang, _message, _validatorMessage, _format, _Dao, _validator, _translateValidator, _view, _init, _domReady, _text, _markdown) {
