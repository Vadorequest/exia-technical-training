...
requirejs([
    ...
    'text',
    "markdown",
], function (_validatorExtended, _languages, _defaultLanguage, _lang, _messageLang, _message, _validatorMessage, _format, _Dao, _validator, _appValidator, _view, _init, _domReady, _text, _markdown) {
