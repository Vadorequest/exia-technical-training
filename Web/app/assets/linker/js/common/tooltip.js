/**
 * This script run when the DOM is loaded and change all elements that contains the tooltip "rel" attribute.
 ...
 * If you don't apply the tooltip "rel" attribute, the tooltip will be generated by bootstrap anyway, but won't use the our default options.
 * And the time required to display the tooltip is higher if the tooltip "rel" attribute is NOT used.
 *
 * @example
 * button_tag space(t('next'), true), class: 'btn btn-next', rel: 'tooltip', title: t('next_step'), 'data-placement' => 'right'
 *
...
$(function(){
    ...
    _.map($('[rel*="tooltip"]'), function(element){
