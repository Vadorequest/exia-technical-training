...
module.exports.views = {
    ...
    engine: {
        /**
         * Load our own version of ejs-locals since the lib is not maintained anymore.
         * See http://stackoverflow.com/questions/25451648/sails-js-how-to-change-a-node-js-module-used-by-sails
         */
        ext: 'ejs',
    ...
    // Need to be set to false for sails to load our custom layout. Our Controller will take care of loading the right layout anyway.
    layout: false
