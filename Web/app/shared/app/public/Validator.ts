...
export class Validator {
     ...
     */
    public static check(params: any, callback: any, res: any): any{
                ...
                try{
                    ...
                    if(rule[j].args){
                        ...
                        if(fct){
                            ...
                            // The function doesn't exists, return debug message.
                            throw {
     ...
     */
    public static rulesUserSessionId(value: string){
        return {
            value: value,
            key: 'userSessionId',
            model: false,
     ...
     * @returns     {{value: *, key: *, rules: Array}}
     */
    public static rulesEmpty(value: string, key: any = false, model: any = false){
        return {
            value: value,
            key: key ? key : false,// Don't link to the model if the key is not defined.
            model: model ? model : false,
     ...
     * @returns     {{value: *, key: *, rules: Array}}
     */
    public static rulesEquals(value: string, confirmation: string, key: any = 'password', model: any = false){
        return {
            value: value,
            key: key ? key : false,// Don't link to the model if the key is not defined.
            model: model ? model : false,
     ...
     * @returns {{value: *, key: string, model: boolean, rules: *[]}}
     */
    public static rulesName(value: string, modelName: string = null, key: string = 'name', minLength = 0, maxLength = 100, model: boolean = true){
        ...
        if(modelName !== null){
            ...
            var _model: any = __Dao.getSchema(modelName);
