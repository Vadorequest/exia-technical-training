...
export class View {
     ...
     */
    public static subTemplate(template, data, options){
     ...
     * @return {boolean}
     */
    public static isActivePage(controller, action, currentController, currentAction){
     ...
     * @return {string}
     */
    public static activePage(controller, action, currentController, currentAction, active = 'active', inactive = ''){
     ...
     * @return {string}
     */
    public static activeController(controller, currentController, active = 'active', inactive = ''){
     ...
     * @return {string}
     */
    public static activeControllerNs(ns, currentController, active = 'active', inactive = ''){
