    ...
    var Validator = (function () {
        ...
        */
        Validator.check = function (params, callback, res) {
            ...
            for (var i = 0; i < paramsToCheck.length; i++) {
                ...
                var key = (paramsToCheck[i].key !== false ? (paramsToCheck[i].key ? paramsToCheck[i].key : 'undefined' + i) : false);
        ...
        */
        Validator.rulesFolderName = function (value, key, minLength, maxLength, model) {
            if (typeof key === "undefined") { key = 'folderName'; }
            if (typeof minLength === "undefined") { minLength = __config.validator.folder.minLength; }
            if (typeof maxLength === "undefined") { maxLength = __config.validator.folder.maxLength; }
        ...
        */
        Validator.rulesResourceName = function (value, key, minLength, maxLength, model) {
            if (typeof key === "undefined") { key = 'resourceName'; }
            if (typeof minLength === "undefined") { minLength = __config.validator.resource.minLength; }
            if (typeof maxLength === "undefined") { maxLength = __config.validator.resource.maxLength; }
            if (typeof model === "undefined") { model = false; }
            return {
                value: value,
                key: key,
        ...
        */
        Validator.rulesFilename = function (value, key, minLength, maxLength, model) {
            if (typeof key === "undefined") { key = 'filename'; }
            if (typeof minLength === "undefined") { minLength = __config.validator.filename.minLength; }
            if (typeof maxLength === "undefined") { maxLength = __config.validator.filename.maxLength; }
            if (typeof model === "undefined") { model = false; }
            return {
                value: value,
                key: key,
        ...
        */
        Validator.rulesId = function (value, key, message, minLength, maxLength) {
            ...
            if (typeof minLength === "undefined") { minLength = __config.validator.mongoDbId.minLength; }
            if (typeof maxLength === "undefined") { maxLength = __config.validator.mongoDbId.maxLength; }
            return {
                value: value,
                key: key ? key : false,
                model: true,
        ...
        */
        Validator.rulesLimit = function (value, min) {
            if (typeof min === "undefined") { min = __config.validator.limit.minLength; }
            return {
                value: value,
                key: 'limit',
                model: true,
        ...
        */
        Validator.rulesLanguageCode = function (value, key, minLength, maxLength, model) {
            if (typeof key === "undefined") { key = 'code'; }
            if (typeof minLength === "undefined") { minLength = __config.validator.languageCode.minLength; }
            if (typeof maxLength === "undefined") { maxLength = __config.validator.languageCode.maxLength; }
            if (typeof model === "undefined") { model = true; }
            return {
                value: value,
                key: key,
